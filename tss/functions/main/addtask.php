							...
							<div class="form-group">
								<form class="form-group" action="db_Instruction/createTask.php" method="post">
									<!-- <div class="btn-day-control">
										<button class="btn-day" > MON </button>
										<button class="btn-day" > TUE </button>
										<button class="btn-day" > WED </button>
										<button class="btn-day" > THU </button>
								...
								<label class="form-label"> Due date: </label>	
									<input class="form-control" name="date" placeholder="MM/DD/YYY" type="text" required style="width: 30%;"> </input>
								...
								<label class="form-label"> Title: </label>	
									<input required name = "titleInput" class="form-control" placeholder="Task Title..."></input>
								<label class="form-label"> Description: </label>
									<textarea name = "descriptionInput" class="form-control" placeholder="Task Description..." rows="5"></textarea>
